...
robN = pygame.transform.rotate(pygame.image.load("image/Robot.png"), +90)
robS = pygame.transform.rotate(pygame.image.load("image/Robot.png"), -90)
robE = pygame.image.load("image/Robot.png")
robW = pygame.transform.rotate(pygame.image.load("image/Robot.png"), 180)
rob = {'N' : robN, 'S' : robS, 'E' : robE, 'W' : robW}
